...
import de.flansen.glucosetracker.common.impl.ColorHelper;
...
public class LumindSlider extends RelativeLayout {
    ...
    private AbstractLumindSliderHandler handler;
    ...
    public void setHandler(AbstractLumindSliderHandler handler) {
