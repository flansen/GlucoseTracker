package de.flhn.cleanboilerplate.domain.interactors.base;


import javax.inject.Inject;

import de.flhn.cleanboilerplate.domain.executor.DaggerThreadExecutionComponent;
import de.flhn.cleanboilerplate.domain.executor.Executor;
import de.flhn.cleanboilerplate.domain.executor.MainThread;
import de.flhn.cleanboilerplate.domain.executor.ThreadExecutionModule;
...
public abstract class AbstractInteractor implements Interactor {
    ...
    public AbstractInteractor() {
        DaggerThreadExecutionComponent.builder()
                .threadExecutionModule(new ThreadExecutionModule())
                .build()
                .inject(this);
    }
